...
// previously inlined in src/main.js now lives here:
...
import { WORLD_W, WORLD_H, PLAYER_SPEED, PLAYER_RADIUS, PLAYER_MAX_HP, XP_MAGNET_RANGE, XP_MAGNET_SPEED } from './constants.js';
import { sfx, getSfxVol, getAudioCtx as getAudio } from './sfx.js';
import { installKeyboardInput } from './input.js';
import { initMusic } from './musicDirector.js';
import { WEAPON_ICONS, createWeapon } from './weapons.js';
import { decorateWeaponCard } from './levelUpCard.js';
import { renderDeathHighlights } from './deathHighlights.js';
import { renderWeaponHistogram } from './weaponPickHistogram.js';
import { powerupIconHTML, relicIconHTML } from './sprites.js';
import { bindResize } from './viewport.js';
import { bindTouchJoystick } from './joystick.js';
import { createRng } from './sim/rng.js';
import { EVT } from './sim/events.js';
import { spawnEnemy } from './sim/enemies.js';
import { POWERUPS } from './sim/powerups.js';
import { RELICS } from './relics.js';
import { buildLevelUpChoices } from './levelUp.js';
import { tickSim } from './sim/tick.js';
import { escapeHTML } from './htmlEscape.js';
import { MAPS, resolveMapObstacles } from './maps.js';
import { pushOutOfObstacles } from './sim/collision.js';
import { buildBackgroundCanvas } from './tileBackground.js';
import { loadObstacleSprites, drawObstacle } from './obstacleSprites.js';
import { drawBackground } from './backgroundRenderer.js';
import { UNLOCKS, calculateScales, loadPrestige, savePrestige, applyPrestigeUnlocks, toggleCosmetic } from './prestige.js';
import { makeDrawSprite, drawHpBar, drawParticles, drawFloatingTexts, drawChainEffects, drawMeteorEffects, drawPendingPulls, drawPlayerBody, drawFacingIndicator, drawChargeTrail, spawnFireTrail, spawnSkinVFX, renderWorld } from './render.js';
import { getAmbient } from './mapAmbient.js';
import { synthesizeView } from './view.js';
import { applySimEvent, resetParticleOverflow, safeParticlePush } from './simEventHandler.js';
import { markSeen } from './bestiary.js';
import { ACHIEVEMENTS, loadAchievements, grantAchievement } from './achievements.js';
import { saveRunEntry } from './runHistory.js';
...
function render() {
  ...
  // from 100% to 30% and zooms the camera 1.0x → 1.5x toward the
  ...
  // Death transition zoom — scale the world 1.0x → 1.5x centered on
